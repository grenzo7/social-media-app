...
Submitted by: **Utsav Ghimire**

This web app: **This is a Social Media App created using ReactJs, Chakra UI, and Firebase. It allows the user to create, read, update and delete posts. This social media app also has login authntication.**
...
<img src='./ezgif.com-video-to-gif (4).gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
